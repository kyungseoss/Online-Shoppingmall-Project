...
<table> 
    <tr class="cen">  
      <td width="300" class="target">상품명</td> 
      <td width="100" class="target">판매가격</td>
      <td width="50" class="target">수량</td> 
      <td width="100" class="target" >금액</td>
    </tr>
<c:set var="total" value="0"/>

  <c:forEach var="cart" items="${cartLists}">
    <tr> 
       <td width="344" class="cen">${cart.getBook_title()}</td> 
...
<table>
   <tr> 
    <td  colspan="2" class="target"><font size="+1" ><b>주문자 정보</b></font></td>
   </tr>
   <tr> 
...
<table>
  <tr> 
   <td  colspan="2" class="target"><font size="+1" ><b>배송지 정보</b></font></td>
  </tr>
  <tr> 
    <td  width="200" align="left">성명</td>
    <td  width="400" align="left">
  ...
  <tr> 
    <td colspan="2" align="center">
       <input type="submit" value="주문" class="tag2">
       <!-- <button id="cancle">취소</button> -->
       <input id = "cancle" type = "button" class="tag2" value = "취소"/>
    </td>
  </tr>
</table>
</form>
